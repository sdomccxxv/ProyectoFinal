// Crud_Puestos.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
void crud_puestos() {
    ...
    while (bandera) {
        ...
        case 5:
            ...
            break;
        default:
            cout << "\nLa opciÃ³n ingresada es erronea \n" << endl;
            break;
        }
...
void crear_puestos() {
    ...
    if (!q_estado) {
        cout << "Marca ingresada con Ã©xito" << endl;
        leer_puestos();
    }
    else {
...
void actualizar_puestos() {
    ...
    q_estado = mysql_query(conectar, i);
    if (!q_estado) {
        cout << "Puesto actualizada con Ã©xito" << endl;
        leer_Puestos();
    }
    else {
